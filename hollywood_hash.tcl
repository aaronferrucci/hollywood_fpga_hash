...
set_instance_parameter_value mem {memorySize} {32768.0}
...
for {set i 0 } {$i < $num_hashers} {incr i} {
  ...
  set_instance_parameter_value pw_mem_$i {dataWidth2} {16}
  set_instance_parameter_value pw_mem_$i {dualPort} {1}
  set_instance_parameter_value pw_mem_$i {enableDiffWidth} {1}
